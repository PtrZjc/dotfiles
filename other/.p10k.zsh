# Generated by Powerlevel10k configuration wizard on 2023-12-01 at 16:25 CET.
...
function prompt_java_version() {
  # Check for the presence of a Gradle or Maven project file
  if [[ -f "build.gradle" || -f "build.gradle.kts" || -f "pom.xml" ]]; then
    # If found, fetch and display the Java version using your method of choice
    local java_version="$(java -version 2>&1 | awk -F '"' '/version/ {print $2}')"
    [[ -n $java_version ]] && p10k segment -f 208 -i '' -t "$java_version"
  fi
}
